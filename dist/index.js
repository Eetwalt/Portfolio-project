(() => {
  ...
  var indexGsapConfig = {
    ...
    animateElements: function() {
      gsapWithCSS.from(".u-border", {
        duration: 3,
        width: 0,
        ease: "power3.inOut"
      });
      gsapWithCSS.to(".marquee-row-1", {
        x: -1500,
        ease: "power1.in",
        scrollTrigger: {
          start: "top top",
      ...
      let tagWrappers = gsapWithCSS.utils.toArray(".work-item-tags");
      tagWrappers.forEach((tagWrapper) => {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    particlesJS("particles-js", particles_default);
